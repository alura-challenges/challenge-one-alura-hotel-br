...
public class RegistroHospede extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHospede frame = new RegistroHospede(null);
			...
			public void mouseClicked(MouseEvent e) {
				if (txtNome.getText() != null && txtSobrenome.getText() != null && txtDataN.getDate() != null
					...
					JOptionPane.showMessageDialog(null,
							"Cadastro efetuado com sucesso! O número da sua reserva é: " + txtNreserva.getText());
	...
	private void salvar() {
		...
		Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getName(), dataN,
				(String) txtNacionalidade.getSelectedItem(), txtTelefone.getText(),
				Integer.parseInt(txtNreserva.getText()));
		this.hospedeControler.salvar(hospede);
	}
